...
class P_11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("DHRUVI",25,'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("VISMIT", 26, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("PRIYANSHI", 20, 'M');
